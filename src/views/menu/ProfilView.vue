<template>
    <div class="flex justify-center">
        <div class="md:w-1/2 lg:w-1/3 flex flex-col w-full h-screen overflow-auto">
            <div class="container flex justify-center pt-2">
                <img :src="image" alt="" srcset="" class="w-40">
            </div>
            <div class="container px-4 py-2 mx-auto pb-20">
                <div class="flex flex-col overflow-auto">
                    <div class="mb-2">
                        <p class="uppercase text-gray-400 font-mulish">Sekolah</p>
                        <p class="font-mulish">{{dataUser.nama_sekolah}}</p>
                    </div>
                    <div class="mb-2">
                        <p class="uppercase text-gray-400  font-mulish">Nama</p>
                        <p class="font-mulish">{{dataUser.nama}}</p>
                    </div>
                    <div class="mb-2">
                        <p class="uppercase text-gray-400 font-mulish">Jabatan</p>
                        <p class="font-mulish">{{dataUser.jabatan}}</p>
                    </div>
                    <div class="mb-2">
                        <p class="uppercase text-gray-400 font-mulish">NIP</p>
                        <p class="font-mulish">{{loginResponse.nip}}</p>
                    </div>
                    <div class="mb-2">
                        <p class="uppercase text-gray-400 font-mulish">Email</p>
                        <p class="font-mulish">{{dataUser.email || '-'}}</p>
                    </div>
                    <div class="mb-2">
                        <p class="uppercase text-gray-400 font-mulish">No. Ponsel</p>
